...
set OUTPUT_DIR=%COCOS2DX_ROOT%/tools/tojs/jsfygui
...
echo Generating bindings for fygui...

python %CXX_GENERATOR_ROOT%/generator.py %TO_JS_ROOT%/fygui.ini -s fygui -o %OUTPUT_DIR% -n jsb_fygui_auto
