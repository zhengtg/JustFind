...
set NDK_ROOT=D:/Develop/Android/android-ndk-r8e
...
set OUTPUT_DIR=%COCOS2DX_ROOT%/tools/tojs/jsbinpack
...
echo Generating bindings for binpack...

python %CXX_GENERATOR_ROOT%/generator.py %TO_JS_ROOT%/binpack.ini -s binpack -o %OUTPUT_DIR% -n jsb_binpack_auto
