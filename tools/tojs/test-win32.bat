...
set OUTPUT_DIR=%COCOS2DX_ROOT%/tools/tojs/jstest
...
echo Generating bindings for test...


python %CXX_GENERATOR_ROOT%/generator.py %TO_JS_ROOT%/test.ini -s testandroid -o %OUTPUT_DIR% -n jsb_test_auto
